...
class TrashLocationUtilsTest {
    ...
    fun passStreetNameAndFeatureAndLocality_returnTrashLocationWithTwoCommas() {
        ...
        //When
        val result = trashLocationUtils.addCommaTrashLocation(
            trashLocation,
    ...
    fun passEmpty_returnTrashLocationWithMessageNoInformationAboutTrash() {
        ...
        val expected = TrashLocation(
            InstrumentationRegistry.getInstrumentation().targetContext.getString(R.string.trash_no_information),
            "",
            ""
        )
